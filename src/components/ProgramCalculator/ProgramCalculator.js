    ...
    return (
        <div className="program-calculator">
            ...
            <div className={`${mainClick ? "calc-container-visible" : "calc-container-hidden"}`}>
                <div className="calc-container-inner">
                    <div onClick={() => setMainClick(!mainClick)} className="close">
                    ...
                    <div className="program-calculator__btns">
                        ...
                        <h1 className="total">${total + virtualTotal + inPersonTotal + remoteTotal} / Month</h1>
                    </div>
                </div>
            </div>
        </div>
